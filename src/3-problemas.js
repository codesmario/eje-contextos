...
/**
 * Recomendaciones 
 * Los contextos no se deben usar en lugares donde se tenga que
 * renderizar mucha información
 * 
 * Utilizarlos en lugares que no van a cambiar
 * como lo son: datos del usuario, idioma 
 */
